...
const userForm = ({ user }) =>{
  const [userSex, setUserSex] = useState(user? sexStringToInt(selectedUser.sex) : 3);
  const [userBirthday, setUserBirthday] = useState(user ? 
    brithdayStringToDate(selectedUser.birthday) : new Date()
  );
