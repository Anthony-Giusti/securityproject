...
var Users = function (_a) {
    ...
    var sortUsers = function (users, order, list) {
        var filteredUsers = users;
        if (order === 'descending') {
            filteredUsers.sort(function (a, b) {
                return a[list].toLowerCase() > b[list].toLowerCase() ? 1 : -1;
            });
        }
        if (order === 'ascending') {
            filteredUsers.sort(function (a, b) {
    ...
    return (react_1.default.createElement("div", { className: classes.usersMain },
        react_1.default.createElement(UsersHeader_1.default, { handleSexFilter: handleSexFilter, sortUsers: handleSortUsers, userData: visibleUserData, sexFilter: sexFilter }),
        visibleUserData.map(function (user) { return (react_1.default.createElement(User_1.default, { key: user._id, user: user, handleRemoveUser: confirmRemoveUser, openEditModal: openEditModal })); }),
        selectedUser && editModalOpen && (react_1.default.createElement(EditModal_1.default, { editModalOpen: editModalOpen, closeEditModal: closeEditModal, selectedUser: selectedUser })),
        selectedUser && (react_1.default.createElement(Dialog_1.default, { open: deleteDialogOpen, onClose: function () { return setDeleteDialogOpen(false); } },
            ...
            react_1.default.createElement(DialogActions_1.default, null,
                react_1.default.createElement(Button_1.default, { variant: "contained", startIcon: react_1.default.createElement(Delete_1.default, null), color: "secondary", onClick: function () { return handleRemoveUser(); } }, "Confirm Delete"),
                react_1.default.createElement(Button_1.default, { onClick: function () { return setDeleteDialogOpen(false); } }, "Cancel"))))));
};
// Users.propTypes = {
